...
def purchasePlaces():
    ...
    if int(club['points']) < placesRequired*number_point_for_a_place:
        ...
        club['points'] = int(club['points']) - placesRequired*number_point_for_a_place
